...
import type { SessionWindows } from "../../state/openclaw-agent-db.generated.js";
...
type SqliteSessionGenerationWindow = Selectable<SessionWindows>;
export type SqliteSessionGenerationClaim = ReturnType<typeof readSqliteSessionGenerationClaim>;
